...
namespace Streamer
{
    ...
    {
        /* -~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
        private readonly string consumerKey = "PUhRhZcpxbcpd2eUWgjdvxb1N";      // register on dev.twitter.com to get
        private readonly string consumerSecret = "qb3JPFWXCfEWSM8EVFHbrZHnaDCEOx84YptoXNhsCrTpNDeVES";  // these for your app
                                                                                                        /* -~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

        private readonly string signatureMethod = "HMAC-SHA1";
        private readonly string version = "1.0";

        private string token = "353684623-PCGotpXstvhmaHEYBPsEpagmf0cKigfkJP560bmW";            // to be set by following token request process
        private string tokenSecret = "T8VPkk1bygJ6eRkZ5UcKamzPQKR9n1kYL5ZWvslpFZPFd";   //
